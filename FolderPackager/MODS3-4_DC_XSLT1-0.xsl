...
<!-- 
  Modified to reject modsCollection and only work for root mods element 2013-04-15 TGH
	...
	The stylesheet will not transform a collection of MODS 3.4 records into, instead it will error
	
	The stylesheet will transform a single MODS 3.4 record into simple Dublin Core (DC)
	as expressed in an <rdf:Description> wrapper
...
-->
	...
	<xsl:template match="/">
		...
		<xsl:when test="//mods:modsCollection">			
			<xsl:message terminate="yes">This XSLT will not work for modsCollection.</xsl:message>
		</xsl:when>
		<xsl:otherwise>
